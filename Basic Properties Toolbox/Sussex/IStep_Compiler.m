...
[E3K_mv,E3K_dvdt] = posthocPhaseprofile(E3_ketamine);
[E3M_mv,E3M_dvdt] = posthocPhaseprofile(E3_memantine);
...
hold on; plot(mean(E4C_mv,2),mean(E4C_dvdt,2),...
    ...
    'DisplayName','E4C')
box off; set(gca,'linewidth',2); set(gcf,'color','white')
title('Genotype'); xlabel('V (mV'); ylabel('dvdt (mV/ms'); legend('LineWidth',1)

% final effect figures
figure; plot(mean(E3C_mv,2),mean(E3C_dvdt,2),...
    'color','black','linewidth',2,...
    'DisplayName','E3C')
hold on; plot(mean(E4K_mv,2),mean(E4K_dvdt,2),...
    ...
    'DisplayName','E4K')
box off; set(gca,'linewidth',2); set(gcf,'color','white')
title('Ketamine Rescue'); xlabel('V (mV'); ylabel('dvdt (mV/ms'); legend('LineWidth',1)
...
hold on; plot(mean(E4M_mv,2),mean(E4M_dvdt,2),...
    ...
    'DisplayName','E4M')
box off; set(gca,'linewidth',2); set(gcf,'color','white')
title('Memantine Rescue'); xlabel('V (mV'); ylabel('dvdt (mV/ms'); legend('LineWidth',1)

% APOE3 and APOE4 +/- ketamine
figure; plot(mean(E4C_mv,2),mean(E4C_dvdt,2),...
    'color','black','linewidth',2,...
    'DisplayName','E4C')
hold on; plot(mean(E4K_mv,2),mean(E4K_dvdt,2),...
    'color','red','linewidth',2,...
    'DisplayName','E4K')
box off; set(gca,'linewidth',2); set(gcf,'color','white')
title('E4 + Ketamine'); xlabel('V (mV'); ylabel('dvdt (mV/ms'); legend('LineWidth',1)

figure; plot(mean(E3C_mv,2),mean(E3C_dvdt,2),...
    'color','black','linewidth',2,...
    'DisplayName','E3C')
hold on; plot(mean(E3K_mv,2),mean(E3K_dvdt,2),...
    'color','red','linewidth',2,...
    'DisplayName','E3K')
box off; set(gca,'linewidth',2); set(gcf,'color','white')
title('E3 + Ketamine'); xlabel('V (mV'); ylabel('dvdt (mV/ms'); legend('LineWidth',1)



% APOE3 and APOE4 +/- memantine
figure; plot(mean(E3C_mv,2),mean(E3C_dvdt,2),...
    'color','black','linewidth',2,...
    'DisplayName','E3C')
hold on; plot(mean(E3M_mv,2),mean(E3M_dvdt,2),...
    'color','red','linewidth',2,...
    'DisplayName','E3M')
box off; set(gca,'linewidth',2); set(gcf,'color','white')
title('E3 + Memantine'); xlabel('V (mV'); ylabel('dvdt (mV/ms'); legend('LineWidth',1)
...
hold on; plot(mean(E4M_mv,2),mean(E4M_dvdt,2),...
    ...
    'DisplayName','E4M')
box off; set(gca,'linewidth',2); set(gcf,'color','white')
title('E4 + Memantine'); xlabel('V (mV'); ylabel('dvdt (mV/ms'); legend('LineWidth',1)
